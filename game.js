...
angular.module('myApp',
    ...
    .controller('Ctrl', function (
        ...
        $scope.move = "[{setTurn: {turnIndex: 1}}, {set: {key: 'board', value: [['','','','','','','',''],['H','','H','','H','','H',''],['','','','','','','',''],['','','','','','','',''],['','','','','','','',''],['','','','','','','',''],['','F','','','','','',''],['','','','','','','','']]}}, {set: {key: 'delta', value: {oldrow: 7, oldcol: 0, row: 6, col: 1}}}]";
        ...
        $scope.cellClicked = function (row, col) {
            ...
            try {
                ...
                $log.info(["you have no moves to make!!", row, col]);
                return;
            }
        };
