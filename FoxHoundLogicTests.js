...
//switched index
    ...
    it("Hound Moves Forwards to the left ", function(){
        expectMoveOk(
            1,  {
                board:[
                    ['','','','','','','',''],
                ...
                delta: {oldrow: 1, oldcol: 0, row: 2, col: 1}
            },
            [{setTurn: {turnIndex : 0}},
                {set: {key: 'board', value: [
                    ['','','','','','','',''],
                ...
                {set: {key: 'delta', value: {oldrow: 5, oldcol: 6, row: 6, col: 5}}}]
        );
    });


    it("Hound Moves Forwards to the right ", function(){
        expectMoveOk(
            1,  {
                board:[
                    ['','','','','','','',''],
            ...
            [{setTurn: {turnIndex : 0}},
                ...
                {set: {key: 'delta', value: {oldrow: 5, oldcol: 0, row: 6, col: 1}}}]
        );
    });
